  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <h1
          className={`text-[#d6482b] text-2xl font-bold mb-2 min-[480px]:text-3xl md:text-3xl xl:text-6xl 2xl:text-6xl`}
        >
          ...
          {steps.map((element, index) => {
            return (
              ...
              >
                ...
                <h3
                  className={`text-[#D6482B] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-xl lg:text-2xl`}
                >
                  {element.title}
                </h3>

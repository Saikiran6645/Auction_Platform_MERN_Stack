...
import FeaturedAuctions from "./home-su-components/FeaturedAuctions";
import UpcomingAuctions from "./home-su-components/UpcomingAuctions";
import Leaderboard from "./home-su-components/Leaderboard";
    ...
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <h1
            className={`text-[#111] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-6xl 6xl:text-7xl`}
          >
            Transparent Auctions
          </h1>
          <h1
            className={`text-[#d6482b] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-6xl 2xl:text-7xl`}
          >
            Be the Winnner
          </h1>

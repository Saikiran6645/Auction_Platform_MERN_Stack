...
const Card = ({ imgSrc, title, startingPrice, startTime, endTime, id }) => {
  ...
  return (
    <>
      <Link
        to={`/auction/item/${id}`}
        className="flex-grow flex-col basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80"
      >
        <img
          src={imgSrc}
          alt={title}
